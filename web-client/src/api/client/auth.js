...
export function loginWithTG(initData = '') {
  return post('/v1/client/auth/tg', { initData }).then((res) => res.data)
}
...
export function getMe() {
  return get('/v1/client/user/me').then((res) => res.data)
}
...
export function getState() {
  return get('/v1/client/state').then((res) => res.data)
}
...
export function updateState(mutations) {
  return put('/v1/client/state', mutations).then((res) => res.data)
}
